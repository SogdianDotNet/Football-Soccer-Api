...
namespace FL.Data.Domain.Context
{
    /// <summary>
    /// 
    /// </summary>
    public class FootballObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public FootballObjectContext(DbContextOptions<FootballObjectContext> options) : base(options)
        { }
